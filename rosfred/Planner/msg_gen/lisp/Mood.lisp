...
(cl:ensure-generic-function 'bottle-val :lambda-list '(m))
(cl:defmethod bottle-val ((m <Mood>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader Planner-msg:bottle-val is deprecated.  Use Planner-msg:bottle instead.")
  (bottle m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Mood>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'bottle)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
    (cl:write-byte (cl:ldb (cl:byte 8 0) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) unsigned) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) unsigned) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Mood>) istream)
  "Deserializes a message object of type '<Mood>"
    ...
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 24) unsigned) (cl:read-byte istream))
      (cl:setf (cl:slot-value msg 'bottle) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
  msg
)
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Mood>)))
  ...
  "836be3908bb8e2eab0e6fc62f409d4d5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Mood)))
  "Returns md5sum for a message object of type 'Mood"
  "836be3908bb8e2eab0e6fc62f409d4d5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Mood>)))
  ...
  (cl:format cl:nil "int32 data~%int32 bottle~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Mood)))
  "Returns full string definition for message of type 'Mood"
  (cl:format cl:nil "int32 data~%int32 bottle~%~%~%"))
